...
col_figpie.plotly_chart(fig_pie)          #Line 78

col_figbar2, col_figline = st.columns(2)   
col_figbar2.plotly_chart(fig_bar2)        #Line 84
col_figline.plotly_chart(fig_line)        #Line 91
...
col_fig_map.plotly_chart(fig_map)         #Line 95               
